...
namespace Unity.LEGO.Minifig
{
    public class MinifigController : MonoBehaviour
    {
        ...
        public void setPlayerNumber(int tmp_playerNumber)
        {
        ...
        public float getInputHorizontal()
        {
            return playerNumber switch
            {
                ...
                2 => Input.GetAxisRaw("Horizontal2"),
                3 => Input.GetAxisRaw("Horizontal3"),
                4 => Input.GetAxisRaw("Horizontal4"),
        ...
        public float getInputVertical()
        {
            return playerNumber switch
            {
                ...
                2 => Input.GetAxisRaw("Vertical2"),
                3 => Input.GetAxisRaw("Vertical3"),
                4 => Input.GetAxisRaw("Vertical4"),
            ...
            if (inputEnabled)
            {
                switch (inputType)
                {
                    case InputType.Tank:
                        {
                            // Calculate speed.
                            var targetSpeed = getInputVertical();
                            ...
                            var targetRotateSpeed = getInputHorizontal();
                    ...
                    case InputType.Direct:
                        {
                            ...
                            var targetSpeed = right * getInputHorizontal();
                            targetSpeed += forward * getInputVertical();
                ...
                // Cancel special.
                cancelSpecial = !Mathf.Approximately(getInputVertical(), 0) || !Mathf.Approximately(getInputHorizontal(), 0) || Input.GetButtonDown("Jump");
